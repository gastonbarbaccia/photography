...
<!-- Mirrored from preview.itgeeksin.com/photography/error.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2019 01:56:15 GMT -->
...
<body>
    ...
    <section class="special-section">
        <div class="special-style dark-overlay">
            <div class="error-style-1 parallax-style"></div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1 col-xs-offset-0">
                        ...
                        <p><i>Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed eiusmod tempor incididunt ut labore et dolore magna aliqua.</i></p>
                        <figure class="error-img">
                            <img src="assets/img/all/404.png" alt="" />
                        </figure>
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-xs-10 col-md-offset-2 col-sm-offset-2 col-xs-offset-1">
                                <a href="index-2.php" class="itg-button">go home</a>
                                <a href="contact.php" class="itg-button">contact</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from preview.itgeeksin.com/photography/error.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2019 01:56:18 GMT -->
