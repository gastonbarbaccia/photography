...
<body>
                        ...
                        <div class="row">
                            <form class="theme-form" action="#" method="post">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <textarea name="message" placeholder="Consulta" rows="8"></textarea>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="submit" name="submit" class="itg-button" value="Enviar">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;key=AIzaSyCIdIjmZwQXmxM_eNnEPMp1YQm4DFXpkkc"></script>
    <script src="assets/js/main.js"></script>
</body>

<!-- Mirrored from preview.itgeeksin.com/photography/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Dec 2019 02:02:53 GMT -->
